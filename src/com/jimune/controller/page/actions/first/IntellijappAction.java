...
public class IntellijappAction extends LaunchAction {

    Program prog;

    public IntellijappAction() {
        super(2, 0, KeyColor.ORANGE_HIGH);

        prog = new Program("P:\\IntelliJ IDEA Community Edition 15.0.3\\bin\\idea.exe");
    }
    ...
    public void press() {
        ...
        if (LaunchPageHandler.curPage.getAction(2, 1) != null) return;

        if (LaunchPageHandler.curPage.addAction(new LaunchAction(2, 1, KeyColor.GREEN_HIGH) {
