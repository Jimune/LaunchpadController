...
public class TimeoutUp extends LaunchAction {

    public TimeoutUp() {
        super(1, 6, KeyColor.GREEN_HIGH);
    }

    @Override
    public void press() {
        if (SharedVars.timeout_modifier + Constants.TIMEOUT_MODIFIER_MODIFIER > Constants.MAX_TIMEOUT_MODIFIER) {
            SharedVars.timeout_modifier = Constants.MAX_TIMEOUT_MODIFIER;
        ...
        Logger.debug("New timeout modifier: " + SharedVars.timeout_modifier);
